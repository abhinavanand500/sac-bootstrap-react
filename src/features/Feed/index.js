        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <form className="form" method="POST" action="/create-tweet">
                        {/* {%csrf_token%} */}
                        <div className="row">
                            ...
                            <div className="col-sm-12 col-md-9">
                                <div className="form-group">
                                    <label forhtml="exampleInputPassword2">Write a feed</label>
                                    <textarea
                                        className="form-control"
                        ...
                        <button type="submit" className="btn btn-primary my-3 mx-auto">
                            Tweet
                        </button>
                    </form>
                </div>
                    ...
                    <div className="card-body bb">
                        <blockquote className="blockquote mb-0">
                            ...
                            <footer className="blockquote-footer my-2">
                                Donation done by - <strong title="Source Title">feed.user1</strong>
                            </footer>
                        </blockquote>
                    </div>
                </div>
