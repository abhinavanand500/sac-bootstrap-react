                            ...
                            <div className="card bg-common card-left bg-common">
                                <div className="card-body">
                                    <nav className="nav d-md-block d-none ">
                                        ...
                                        <a data-toggle="tab" className="nav-link" href="#account">
                                            <i className="fa fa-user-cog mr-1" aria-hidden="true" />
                                            Account Settings
                                        </a>
                                ...
                                <div className="card-body tab-content border-0">
                                    <div className="tab-pane active" id="profile">
                                        ...
                                        <form action="/profile" method="POST">
                                            ...
                                            <div className="form-group form-text text-muted small">
                                                Please check your Details and update it, if it is
                                                Incorrect
                                            </div>
                                            <br />
                                            <button
                                    ...
                                    <div className="tab-pane" id="account">
                                        ...
                                        <form action="/delete" method="POST">
                                            <div className="mb-3">
                                                ...
                                                <small className="form-text text-muted">
                                                    You will loose all your data if you delete this
                                                    Account.
                                                </small>
                                                <hr />
                                                <h6
                                    ...
                                    <div className="tab-pane" id="security">
                                        ...
                                        <form action="/changepassword" method="POST">
                                            <label forhtml="inputPassword5" className="form-label">
                                                Change Password
                                            </label>
                                            <input
                                                type="password"
                                        ...
                                        <p className="text-muted small">
                                            This is the list of Device From which you have logged
                                            into your account
                                        </p>
                                            ...
                                            <li className="list-group-item">
                                                <div>
                                                    ...
                                                    <small className="text-muted">
                                                        Your Current Session is in INDIA
                                                    </small>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div className="tab-pane" id="notification">
                                        ...
                                        <form>
                                            ...
                                            <div id="passwordHelpBlock" className="form-text">
                                                Recieve Security Alert message in your Email
                                            </div>
                                            <div className="form-check mt-2">
                                                ...
                                                >
                                                    Email each time when your account gets logged In
                                                </label>
                                            </div>
                                            <div className="form-check">
                                                ...
                                                >
                                                    Email your all ongoing detail of each months
                                                </label>
                                            </div>
                                            <hr />
                                            <div className="mb-3">
                                                <label className="d-block">SMS Notification</label>
                                                <ul className="list-group">
                                                    <li className="list-group-item">
                                                        <div>
                                                            <h6>Comments</h6>
